...
def select_front_image():
    ...
    front_image_path = resource_path(filedialog.askopenfilename( title="Select Front Image", filetypes=(("jpeg files", "*.jpg"), ("png files", "*.png"))))
    # messagebox.showinfo("Front Image Selected", "Front Image Selected Successfully")

def select_back_image():
    global back_image_path
    back_image_path = resource_path(filedialog.askopenfilename( title="Select Back Image", filetypes=(("jpeg files", "*.jpg"), ("png files", "*.png"))))
...
def extract():
    ...
    if front_image_path == "" or back_image_path == "":
        ...
        output = OCR_Engine.extract(front_image, back_image)
